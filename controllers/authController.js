...
exports.register = catchAsync(async (req, res, next) => {
    ...
    // Send welcome email
    await new EmailTransmitter(user, url).sendWelcomeEmail()
})
...
exports.login = catchAsync(async (req, res, next) => {
    ...
    if (!email || !password) {
        ...
        return next(
            new AppError('Email and password both fields are required', 400)
        )
    }
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
    ...
    try {
        ...
        await new EmailTransmitter(user, resetURL).sendPasswordResetEmail()
